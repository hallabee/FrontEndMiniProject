...
function updateProfileCard() {
    ...
    profileCard.querySelector('h4').textContent = selectedProfile.querySelector('h4').textContent;
    profileCard.querySelector('p').textContent = selectedProfile.querySelector('p').textContent;
...
function updateSideCards() {
    ...
    prevCard.querySelector('h4').textContent = profileLinks[prevIndex].querySelector('h4').textContent;

    // 다음 카드 업데이트
    nextCard.querySelector('.profile-img').src = profileLinks[nextIndex].querySelector('.profile-img').src;
    nextCard.querySelector('h4').textContent = profileLinks[nextIndex].querySelector('h4').textContent;
}
